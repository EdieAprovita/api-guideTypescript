...
const sampleRecipes = [
  {
    ...
    instructions: 'Soak cashews for 2 hours. Blend with nutritional yeast, garlic, and plant milk. Cook pasta and toss with sauce.',
    ingredients: ['400g pasta', '1 cup raw cashews', '1/4 cup nutritional yeast', '3 garlic cloves', '1 cup plant milk', 'Salt and pepper'],
  ...
  },
  {
    ...
    ingredients: ['1 cup quinoa', '2 cups kale', '1 cup chickpeas', '1 avocado', '1 carrot', '1/4 cup tahini', '2 tbsp lemon juice'],
    typeDish: 'Main Course',
  ...
  },
  {
    ...
    instructions: 'Blend ripe avocados with cocoa powder, maple syrup, and vanilla. Chill for 2 hours before serving.',
    ingredients: ['3 ripe avocados', '1/4 cup cocoa powder', '1/4 cup maple syrup', '1 tsp vanilla extract', 'Pinch of salt'],
    typeDish: 'Dessert',
