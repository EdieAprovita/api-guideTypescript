...
app.get('/test-param-validation/:id', 
  validate({ params: paramSchemas.id }), 
  (req, res) => res.json({ success: true, params: req.params })
);
...
describe('Validation Middleware Tests', () => {
  describe('Input Validation', () => {
    ...
    it('should validate ObjectId parameters', async () => {
      ...
      const response = await request(app)
        .get(`/test-param-validation/${validObjectId}`);
    ...
    it('should reject invalid ObjectId parameters', async () => {
      ...
      const response = await request(app)
        .get(`/test-param-validation/${invalidObjectId}`);
