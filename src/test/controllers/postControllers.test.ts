...
describe('Post Controllers', () => {
    ...
    describe('Get all posts', () => {
        it('should get all posts', async () => {
            ...
            (postService.getAll as Mock).mockResolvedValueOnce(mockPosts);
    ...
    describe('Get post by id', () => {
        it('should get post by id', async () => {
            ...
            (postService.findById as Mock).mockResolvedValueOnce(mockPost);
    ...
    describe('Create post', () => {
        it('should create a new post', async () => {
            ...
            (postService.create as Mock).mockResolvedValueOnce(createdPost);
    ...
    describe('Update post', () => {
        it('should update post by id', async () => {
            ...
            (postService.updateById as Mock).mockResolvedValueOnce(updatedPost);
    ...
    describe('Delete post', () => {
        it('should delete post by id', async () => {
            const postId = 'post123';
            (postService.deleteById as Mock).mockResolvedValueOnce(undefined);
    ...
    describe('Like post', () => {
        it('should like a post', async () => {
            const postId = 'post123';
            (postService.likePost as Mock).mockResolvedValueOnce([]);
    ...
    describe('Unlike post', () => {
        it('should unlike a post', async () => {
            const postId = 'post123';
            (postService.unlikePost as Mock).mockResolvedValueOnce([]);
            const response = await request(app)
    ...
    describe('Add comment', () => {
        it('should add comment to post', async () => {
            ...
            (postService.addComment as Mock).mockResolvedValueOnce(addedComment);
